...
/**
 * ================================================================= 
 * Source file taken from :: wlclient.android.preview.js
 * ================================================================= 
 */
...
WL.Client.createDeviceAuthChallengeHandler = function(realmName) {
    // Creates SUPER challenge processor
    var challengeHandler = WL.Client.createSecurityCheckChallengeHandler(realmName);

    challengeHandler.getDeviceAuthDataAsync = function(deviceAuthSettings){

    	var deviceID = "dummyDeviceID";
		var osModel = "dummyOsModel";
...
//Object used in native
var WLCordovaSplashScreenDialog = {};


/**
 * ================================================================= 
 * Source file taken from :: wlgap.android.preview.js
 * ================================================================= 
 */
...
WL.App.resetDeviceID = function(successCallback, failCallback) {
	failCallback("Reset Device ID feature is not supported in preview.");
};

WL.App.setDeviceID = function(uuid,successCallback, failCallback) {
	failCallback("set Device ID feature is not supported in preview.");
};
